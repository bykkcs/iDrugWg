...
public class AppListItemBindingImpl extends AppListItemBinding implements pw.idrug.connections.generated.callback.OnClickListener.Listener {
    ...
    private androidx.databinding.InverseBindingListener selectedCheckboxandroidCheckedAttrChanged = new androidx.databinding.InverseBindingListener() {
        ...
        public void onChange() {
            ...
            // item
            pw.idrug.connections.model.ApplicationData item = mItem;
            // item != null
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.item == variableId) {
            setItem((pw.idrug.connections.model.ApplicationData) variable);
        }
        else if (BR.collection == variableId) {
            setCollection((pw.idrug.connections.databinding.ObservableKeyedArrayList<java.lang.String,pw.idrug.connections.model.ApplicationData>) variable);
        }
    ...
    public void setItem(@Nullable pw.idrug.connections.model.ApplicationData Item) {
    ...
    public void setCollection(@Nullable pw.idrug.connections.databinding.ObservableKeyedArrayList<java.lang.String,pw.idrug.connections.model.ApplicationData> Collection) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeItem((pw.idrug.connections.model.ApplicationData) object, fieldId);
            case 1 :
                return onChangeCollection((pw.idrug.connections.databinding.ObservableKeyedArrayList<java.lang.String,pw.idrug.connections.model.ApplicationData>) object, fieldId);
        }
        return false;
    }
    private boolean onChangeItem(pw.idrug.connections.model.ApplicationData Item, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    private boolean onChangeCollection(pw.idrug.connections.databinding.ObservableKeyedArrayList<java.lang.String,pw.idrug.connections.model.ApplicationData> Collection, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x2L;
            }
