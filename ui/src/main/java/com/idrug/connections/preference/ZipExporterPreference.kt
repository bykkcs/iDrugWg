 ...
 */
package com.idrug.connections.preference
...
import com.idrug.connections.util.AdminKnobs
import com.idrug.connections.util.BiometricAuthenticator
import com.idrug.connections.util.DownloadsFileSaver
import com.idrug.connections.util.ErrorMessages
import com.idrug.connections.util.activity
import com.idrug.connections.util.lifecycleScope
...
class ZipExporterPreference(context: Context, attrs: AttributeSet?) : Preference(context, attrs) {
        ...
        lifecycleScope.launch {
            ...
            try {
                exportedFilePath = withContext(Dispatchers.IO) {
                    ...
                    val outputFile = downloadsFileSaver.save("idrugwg-export.zip", "application/zip", true)
                    if (outputFile == null) {
    ...
    companion object {
        private const val TAG = "iDrugWG/ZipExporterPreference"
    }
}
