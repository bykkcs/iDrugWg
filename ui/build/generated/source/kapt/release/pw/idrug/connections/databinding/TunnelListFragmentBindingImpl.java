...
public class TunnelListFragmentBindingImpl extends TunnelListFragmentBinding  {
    ...
    private pw.idrug.connections.databinding.ObservableKeyedRecyclerViewAdapter.RowConfigurationHandler mOldRowConfigurationHandler;
    // listeners
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.fragment == variableId) {
            ...
            setRowConfigurationHandler((pw.idrug.connections.databinding.ObservableKeyedRecyclerViewAdapter.RowConfigurationHandler) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setRowConfigurationHandler(@Nullable pw.idrug.connections.databinding.ObservableKeyedRecyclerViewAdapter.RowConfigurationHandler RowConfigurationHandler) {
    ...
    protected void executeBindings() {
        ...
        pw.idrug.connections.databinding.ObservableKeyedRecyclerViewAdapter.RowConfigurationHandler<? extends androidx.databinding.ViewDataBinding,?> rowConfigurationHandler = mRowConfigurationHandler;
        ...
        if ((dirtyFlags & 0xdL) != 0) {
            ...
            pw.idrug.connections.databinding.BindingAdapters.setItems(this.tunnelList, this.mOldTunnels, this.mOldAndroidLayoutTunnelListItem, this.mOldRowConfigurationHandler, tunnels, R.layout.tunnel_list_item, rowConfigurationHandler);
        }
        if ((dirtyFlags & 0xdL) != 0) {
