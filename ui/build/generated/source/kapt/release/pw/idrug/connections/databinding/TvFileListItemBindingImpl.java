...
public class TvFileListItemBindingImpl extends TvFileListItemBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.item == variableId) {
            setItem((pw.idrug.connections.activity.TvMainActivity.KeyedFile) variable);
        }
    ...
    public void setItem(@Nullable pw.idrug.connections.activity.TvMainActivity.KeyedFile Item) {
        this.mItem = Item;
    }
