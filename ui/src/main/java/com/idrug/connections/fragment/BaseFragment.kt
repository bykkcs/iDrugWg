...
import com.idrug.connections.activity.BaseActivity
import com.idrug.connections.activity.BaseActivity.OnSelectedTunnelChangedListener
import com.idrug.connections.backend.GoBackend
import com.idrug.connections.backend.Tunnel
import com.idrug.connections.databinding.TunnelDetailFragmentBinding
...
abstract class BaseFragment : Fragment(), OnSelectedTunnelChangedListener {
    ...
    companion object {
        private const val TAG = "iDrugWG/BaseFragment"
    }
}
