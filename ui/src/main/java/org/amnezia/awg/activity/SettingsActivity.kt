...
private fun checkForOtaUpdate() {
    try {
        ...
        if (file.exists()) {
            ...
            if (!deleted) {
                Toast.makeText(context, getString(R.string.update_delete_failed), Toast.LENGTH_SHORT).show()
            }
        }
        ...
        Toast.makeText(context, getString(R.string.update_started), Toast.LENGTH_SHORT).show()
