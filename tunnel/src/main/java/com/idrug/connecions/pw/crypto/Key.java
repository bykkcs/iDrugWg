...
package com.idrug.connecions.pw.crypto;

import com.idrug.connecions.pw.crypto.KeyFormatException.Type;
...
/**
 * Represents an iDrugWg public or private key. This class uses specialized constant-time base64
...
public final class Key {
    ...
    /**
     * Decodes an iDrugWg public or private key from its base64 string representation. This
     * function throws a {@link KeyFormatException} if the source string is not well-formed.
     *
     * @param str the base64 string representation of an iDrugWg key
    ...
    /**
     * Wraps an iDrugWg public or private key in an immutable container. This function throws a
     * {@link KeyFormatException} if the source data is not the correct length.
     *
     * @param bytes an array of bytes containing an iDrugWg key in binary format
    ...
    /**
     * Decodes an iDrugWg public or private key from its hexadecimal string representation. This
     * function throws a {@link KeyFormatException} if the source string is not well-formed.
     *
     * @param str the hexadecimal string representation of an iDrugWg key
     * @return the decoded key encapsulated in an immutable container
     */
    ...
    /**
     * The supported formats for encoding an iDrugWg key.
     */
    public enum Format {
        BASE64(44),
        BINARY(32),
