...
public class TvActivityBindingImpl extends TvActivityBinding  {
    ...
    // variables
    // values
    private pw.idrug.connections.databinding.ObservableKeyedArrayList<java.lang.String,pw.idrug.connections.activity.TvMainActivity.KeyedFile> mOldFiles;
    private int mOldAndroidLayoutTvFileListItem;
    private pw.idrug.connections.databinding.ObservableKeyedRecyclerViewAdapter.RowConfigurationHandler mOldFilesRowConfigurationHandler;
    private pw.idrug.connections.databinding.ObservableKeyedArrayList<java.lang.String,pw.idrug.connections.model.ObservableTunnel> mOldTunnels;
    private int mOldAndroidLayoutTvTunnelListItem;
    private pw.idrug.connections.databinding.ObservableKeyedRecyclerViewAdapter.RowConfigurationHandler mOldTunnelRowConfigurationHandler;
    // listeners
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.filesRoot == variableId) {
            ...
            setFiles((pw.idrug.connections.databinding.ObservableKeyedArrayList<java.lang.String,pw.idrug.connections.activity.TvMainActivity.KeyedFile>) variable);
        }
        else if (BR.filesRowConfigurationHandler == variableId) {
            setFilesRowConfigurationHandler((pw.idrug.connections.databinding.ObservableKeyedRecyclerViewAdapter.RowConfigurationHandler) variable);
        }
            ...
            setTunnels((pw.idrug.connections.databinding.ObservableKeyedArrayList<java.lang.String,pw.idrug.connections.model.ObservableTunnel>) variable);
        }
        else if (BR.tunnelRowConfigurationHandler == variableId) {
            setTunnelRowConfigurationHandler((pw.idrug.connections.databinding.ObservableKeyedRecyclerViewAdapter.RowConfigurationHandler) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setFiles(@Nullable pw.idrug.connections.databinding.ObservableKeyedArrayList<java.lang.String,pw.idrug.connections.activity.TvMainActivity.KeyedFile> Files) {
    ...
    public void setFilesRowConfigurationHandler(@Nullable pw.idrug.connections.databinding.ObservableKeyedRecyclerViewAdapter.RowConfigurationHandler FilesRowConfigurationHandler) {
    ...
    public void setTunnels(@Nullable pw.idrug.connections.databinding.ObservableKeyedArrayList<java.lang.String,pw.idrug.connections.model.ObservableTunnel> Tunnels) {
    ...
    public void setTunnelRowConfigurationHandler(@Nullable pw.idrug.connections.databinding.ObservableKeyedRecyclerViewAdapter.RowConfigurationHandler TunnelRowConfigurationHandler) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 1 :
                return onChangeFiles((pw.idrug.connections.databinding.ObservableKeyedArrayList<java.lang.String,pw.idrug.connections.activity.TvMainActivity.KeyedFile>) object, fieldId);
            case 2 :
                return onChangeIsDeleting((androidx.databinding.ObservableBoolean) object, fieldId);
            case 3 :
                return onChangeTunnels((pw.idrug.connections.databinding.ObservableKeyedArrayList<java.lang.String,pw.idrug.connections.model.ObservableTunnel>) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeFiles(pw.idrug.connections.databinding.ObservableKeyedArrayList<java.lang.String,pw.idrug.connections.activity.TvMainActivity.KeyedFile> Files, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x2L;
            }
    ...
    private boolean onChangeTunnels(pw.idrug.connections.databinding.ObservableKeyedArrayList<java.lang.String,pw.idrug.connections.model.ObservableTunnel> Tunnels, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x8L;
            }
    ...
    protected void executeBindings() {
        ...
        pw.idrug.connections.databinding.ObservableKeyedArrayList<java.lang.String,pw.idrug.connections.activity.TvMainActivity.KeyedFile> files = mFiles;
        ...
        pw.idrug.connections.databinding.ObservableKeyedRecyclerViewAdapter.RowConfigurationHandler<? extends androidx.databinding.ViewDataBinding,?> filesRowConfigurationHandler = mFilesRowConfigurationHandler;
        ...
        pw.idrug.connections.databinding.ObservableKeyedArrayList<java.lang.String,pw.idrug.connections.model.ObservableTunnel> tunnels = mTunnels;
        boolean tunnelsIsEmpty = false;
        java.lang.String filesRootGet = null;
        pw.idrug.connections.databinding.ObservableKeyedRecyclerViewAdapter.RowConfigurationHandler<? extends androidx.databinding.ViewDataBinding,?> tunnelRowConfigurationHandler = mTunnelRowConfigurationHandler;
        ...
        if ((dirtyFlags & 0x52L) != 0) {
            ...
            pw.idrug.connections.databinding.BindingAdapters.setItems(this.filesList, this.mOldFiles, this.mOldAndroidLayoutTvFileListItem, this.mOldFilesRowConfigurationHandler, files, R.layout.tv_file_list_item, filesRowConfigurationHandler);
        }
        if ((dirtyFlags & 0x49L) != 0) {
            // api target 1
        ...
        if ((dirtyFlags & 0x68L) != 0) {
            ...
            pw.idrug.connections.databinding.BindingAdapters.setItems(this.tunnelList, this.mOldTunnels, this.mOldAndroidLayoutTvTunnelListItem, this.mOldTunnelRowConfigurationHandler, tunnels, R.layout.tv_tunnel_list_item, tunnelRowConfigurationHandler);
        }
        if ((dirtyFlags & 0x52L) != 0) {
