...
public class TunnelEditorPeerBindingImpl extends TunnelEditorPeerBinding implements pw.idrug.connections.generated.callback.OnClickListener.Listener {
    ...
    private TunnelEditorPeerBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback3 = new pw.idrug.connections.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.item == variableId) {
            ...
            setCollection((androidx.databinding.ObservableList<pw.idrug.connections.viewmodel.PeerProxy>) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setCollection(@Nullable androidx.databinding.ObservableList<pw.idrug.connections.viewmodel.PeerProxy> Collection) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 1 :
                return onChangeCollection((androidx.databinding.ObservableList<pw.idrug.connections.viewmodel.PeerProxy>) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeCollection(androidx.databinding.ObservableList<pw.idrug.connections.viewmodel.PeerProxy> Collection, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x2L;
            }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x7f9L) != 0) {
            ...
            if ((dirtyFlags & 0x421L) != 0) {
                    ...
                    bindingAdaptersTryParseIntItemPersistentKeepalive = pw.idrug.connections.databinding.BindingAdapters.tryParseInt(itemPersistentKeepalive);
        ...
        if ((dirtyFlags & 0x400L) != 0) {
            ...
            pw.idrug.connections.databinding.BindingAdapters.setFilter(this.preSharedKeyText, pw.idrug.connections.widget.KeyInputFilter.newInstance());
            ...
            pw.idrug.connections.databinding.BindingAdapters.setFilter(this.publicKeyText, pw.idrug.connections.widget.KeyInputFilter.newInstance());
        ...
        if ((dirtyFlags & 0x404L) != 0) {
            ...
            pw.idrug.connections.databinding.BindingAdapters.setOnFocusChange(this.preSharedKeyText, fragmentOnKeyFocusChangeAndroidViewViewOnFocusChangeListener);
        }
        if ((dirtyFlags & 0x411L) != 0) {
            // api target 1
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        ...
        public OnClickListenerImpl setValue(pw.idrug.connections.fragment.TunnelEditorFragment value) {
            this.value = value;
