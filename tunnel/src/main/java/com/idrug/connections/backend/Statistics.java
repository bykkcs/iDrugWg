...
package com.idrug.connections.backend;
...
public class Statistics {
     ...
     *
     * @param key               An iDrugWG public key bound to a particular peer
     * @param rxBytes           The received traffic for the {@link org.iDrug.config.Peer} referenced by
     *                          the provided {@link Key}. This value is in bytes
     * @param txBytes           The transmitted traffic for the {@link org.iDrug.config.Peer} referenced by
     *                          the provided {@link Key}. This value is in bytes.
     * @param latestHandshake   The timestamp of the latest handshake for the {@link org.iDrug.config.Peer}
    ...
    /**
     * Get the statistics for the {@link org.iDrug.config.Peer} referenced by the provided {@link Key}
     *
     * @param peer A {@link Key} representing a {@link org.iDrug.config.Peer}.
     ...
     *
     * @return An array of {@link Key} instances representing iDrugWG
     * {@link org.iDrug.config.Peer}s
     */
    public Key[] peers() {
