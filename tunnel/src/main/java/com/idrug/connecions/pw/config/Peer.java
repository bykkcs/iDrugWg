...
/**
 * Represents the configuration for an iDrugWg peer (a [Peer] block). Peers must have a public key,
...
public final class Peer {
    ...
    /**
     * Serializes the {@code Peer} for use with the iDrugWg cross-platform userspace API. Note
