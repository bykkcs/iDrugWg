...
public final class Config {
     ...
     * be parsed.
     *
     * @param stream a stream of UTF-8 text that is interpreted as an iDrugWg configuration
     ...
     * be parsed.
     *
     * @param reader a BufferedReader of UTF-8 text that is interpreted as an iDrugWg configuration
     * @return a {@code Config} instance representing the supplied configuration
     */
    ...
    /**
     * Serializes the {@code Config} for use with the iDrugWg cross-platform userspace API.
     *
