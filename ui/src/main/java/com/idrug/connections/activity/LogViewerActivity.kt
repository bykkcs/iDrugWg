...
import com.idrug.connections.BuildConfig
import com.idrug.connections.R
import com.idrug.connections.databinding.LogViewerActivityBinding
import com.idrug.connections.util.DownloadsFileSaver
import com.idrug.connections.util.ErrorMessages
import com.idrug.connections.util.resolveAttribute
...
class LogViewerActivity : AppCompatActivity() {
    ...
    private suspend fun saveLog() {
        ...
        withContext(Dispatchers.IO) {
            try {
                outputFile = downloadsFileSaver.save("idrugwg-log.txt", "text/plain", true)
    ...
    companion object {
        ...
        private const val TAG = "iDrugWG/LogViewerActivity"
    }
    ...
    class ExportedLogContentProvider : ContentProvider() {
        ...
        override fun query(uri: Uri, projection: Array<out String>?, selection: String?, selectionArgs: Array<out String>?, sortOrder: String?): Cursor? =
            logForUri(uri)?.let {
                ...
                m.addRow(arrayOf("idrugwg-log.txt", it.size.toLong()))
                m
            }
