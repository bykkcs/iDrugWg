...
**iDrugConnections** — это официальный VPN-клиент от команды **iDrug**.  
...
1. Клонируй репозиторий:
   ...
   git clone https://github.com/bykkcs/idrugconnections.git
...
**iDrugConnections** — VPN, который не осуждает.  
