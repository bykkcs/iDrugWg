...
package com.idrug.connecions.pw.config;

import com.idrug.connecions.pw.config.BadConfigException.Location;
import com.idrug.connecions.pw.config.BadConfigException.Reason;
import com.idrug.connecions.pw.config.BadConfigException.Section;
import com.idrug.connecions.pw.crypto.Key;
import com.idrug.connecions.pw.crypto.KeyFormatException;
import com.idrug.connecions.pw.crypto.KeyPair;
import com.idrug.connecions.pw.util.NonNullForAll;
...
/**
 * Represents the configuration for an iDrugWg interface (an [Interface] block). Interfaces must
...
public final class Interface {
    ...
    /**
     * Returns the UDP port number that the iDrugWg interface will listen on.
     *
    ...
    /**
     * Returns the MTU used for the iDrugWg interface.
     *
    ...
    /**
     * Returns the junkPacketCount used for the iDrugWg interface.
     *
    ...
    /**
     * Returns the junkPacketMinSize used for the iDrugWg interface.
     *
    ...
    /**
     * Returns the junkPacketMaxSize used for the iDrugWg interface.
     *
    ...
    /**
     * Returns the initPacketJunkSize used for the iDrugWg interface.
     *
    ...
    /**
     * Returns the responsePacketJunkSize used for the iDrugWg interface.
     *
    ...
    /**
     * Returns the initPacketMagicHeader used for the iDrugWg interface.
     *
    ...
    /**
     * Returns the responsePacketMagicHeader used for the iDrugWg interface.
     *
    ...
    /**
     * Returns the underloadPacketMagicHeader used for the iDrugWg interface.
     *
    ...
    /**
     * Returns the transportPacketMagicHeader used for the iDrugWg interface.
     *
    ...
    /**
     * Serializes the {@code Interface} for use with the iDrugWg cross-platform userspace API.
